# TOON-JAVA Library Versioning Policy

This document outlines the versioning policy for the TOON-JAVA Library.

## Semantic Versioning

The TOON-JAVA Library follows [Semantic Versioning](https://semver.org/) with a `MAJOR.MINOR` format (specifications don't need PATCH versions).
